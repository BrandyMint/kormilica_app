...
(function() {
  ...
  define('views/wide_layout',['templates/wide_layout', 'helpers/application_helpers'], function(template, Helpers) {
    ...
    return WideLayout = (function(_super) {
      ...
      WideLayout.prototype.className = 'kormapp-wide-layout';
...
(function() {
  ...
  define('views/narrow_layout',['templates/narrow_layout', 'helpers/application_helpers'], function(template, Helpers) {
    ...
    return NarrowLayout = (function(_super) {
      ...
      NarrowLayout.prototype.className = 'kormapp-narrow-layout';
...
(function() {
  ...
  define('views/categories/category_list_narrow',['views/categories/category'], function(CategoryView) {
    ...
    return CategoryListNarrow = (function(_super) {
      ...
      CategoryListNarrow.prototype.initialize = function() {
        var _this = this;
        return this.on('itemview:category:click', function() {
  ...
  define('pull_down/controller',[],function() {
    ...
    return PullDownController = (function(_super) {
      ...
      PullDownController.prototype.clickStopperShow = function() {
        var _this = this;
        return setTimeout((function() {
          _this.clickStopper = $(_this.clickStopperTemplate);
          _this.view.$el.append(_this.clickStopper);
          _this.clickStopper.height($(window).height() + _this.maxHeight);
          _this.clickStopper.width($(window).width());
          return _this.clickStopper.one('click', _this._hide);
        }), 500);
      };
