  ...
  define('templates/check/check_cart_item',[],function() {
    return function(context) {
      ...
      render = function() {
        ...
        $o = [];
        $o.push("<p>" + ($c(this.product_title)) + "</p>\n<table>\n  <tbody>\n    <tr>\n      <td class='product-amount'>");
  ...
  define('views/check/check',['templates/check/check', 'views/check/check_cart_item', 'helpers/application_helpers'], function(template, CheckCartItemView, Helpers) {
    ...
    return Check = (function(_super) {
      ...
      Check.prototype.deactivateDeliveryButton = function() {
        var button;
        button = this.$('#kormapp-check-bottom-container').find('.delivery');
        return button.removeClass('delivery').addClass('delivery-inactive');
      };

      Check.prototype.activateDeliveryButton = function() {
        var button;
        button = this.$('#kormapp-check-bottom-container').find('.delivery-inactive');
  ...
  define('templates/header/top_check',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='top-check'>\n  <span class='check-background-image'></span>\n  <img class='check-image' src='images/top-check.png'>\n</div>\n<p>ваш заказ на \n  <br>\n  <span id='kormapp-amount'></span>\n</p>");
...
(function() {
  ...
  define('views/header/top_check',['templates/header/top_check', 'helpers/application_helpers'], function(template, Helpers) {
    ...
    return TopCheckView = (function(_super) {
      ...
      TopCheckView.prototype.slideUp = function() {
        var checkHeight, checkMarginTop;
        checkHeight = this.ui.checkImage.height();
        checkMarginTop = parseInt(this.ui.checkImage.css('margin-top'));
        return this.ui.checkImage.css('margin-top', checkHeight + checkMarginTop).animate({
  ...
  define('templates/header/header',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='clearfix row'>\n  <div class='column half' id='kormapp-logo'>\n    <img src='images/logo.png'>\n    <p>Доставка <br> пончиков</p>\n  </div>\n  <div class='column half' id='kormapp-top-check'></div>\n</div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
(function() {
  ...
  define('views/header/header',['views/header/top_check', 'templates/header/header', 'helpers/application_helpers'], function(TopCheckView, template, Helpers) {
    ...
    return HeaderView = (function(_super) {
      ...
      HeaderView.prototype.className = 'header row';
  ...
  define('templates/products/button_added',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<a class='button in-order' href='#777'>\n  <span class='to-bucket to-bucket-orange'></span>\n  <span>\n    В ЗАКАЗE\n    <span class='karmapp-cart_item-quantity'></span>\n    шт\n  </span>\n</a>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
  ...
  define('templates/products/empty_button',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<a class='button' href='#777'>\n  <span class='to-bucket to-bucket-regular'></span>\n  <span>В ЗАКАЗ</span>\n</a>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
(function() {
  ...
  define('views/footer/footer',['templates/footer/footer', 'templates/footer/_checkout'], function(template, checkoutButtonTemplate) {
    var Footer, _ref;
    return Footer = (function(_super) {
      ...
      Footer.prototype.initialize = function(options) {
        var _this = this;
        this.vent = options.vent, this.cart = options.cart, this.vendor = options.vendor;
        this.collection = this.cart.items;
  ...
  define('templates/main_layout',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div id='kormapp-header-region'></div>\n<div class='content' id='kormapp-main-region'></div>\n<div class='footer' id='kormapp-footer-region'></div>\n<div class='check' id='kormapp-check-region'></div>\n<div class='modal' id='kormapp-modal-region'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
  ...
  define('data/bundle',[],function() {
    return {
      "vendor": {
        ...
        "mobile_delivery": "Доставка бесплатно от 500 руб.",
        "mobile_logo": {
          "mobile_url": "data/images/mobile_logo.jpg"
        },
        "minimal_price": {
          "cents": 55000,
          "currency": "RUB"
