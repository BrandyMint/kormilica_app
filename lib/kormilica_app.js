...
(function() {
  ...
  require.config({
    shim: {
      ...
      app: {
        deps: ['cordovaShim', 'marionette', 'backbone.stickit', 'backbone.localStorage', 'backbone.virtualcollection', 'jquery.ui.effect', 'jquery.ui.effect-bounce', 'rolejs']
      }
    },
    paths: {
  ...
  if (!this.Marionette) {
    require(['underscore', 'backbone', 'backbone.stickit', 'backbone.virtualcollection', 'backbone.localStorage', 'marionette', 'jquery.ui.effect', 'jquery.ui.effect-bounce', 'rolejs'], function(Underscore, Backbone, Stickit, VirtualCollection, LocalStorage, Marionette) {
