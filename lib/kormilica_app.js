  ...
  define('templates/categories/category_list_narrow',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='list-container' role='list-container'></div>\n<div class='pull-tag' role='pull-tag'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
(function() {
  ...
  define('views/categories/category_list_narrow',['templates/categories/category_list_narrow', 'views/categories/category'], function(template, CategoryView) {
    ...
    return CategoryListNarrow = (function(_super) {
      ...
      CategoryListNarrow.prototype.className = 'categories-list-narrow';

      CategoryListNarrow.prototype.itemView = CategoryView;

      CategoryListNarrow.prototype.itemViewContainer = '@list-container';
      ...
      CategoryListNarrow.prototype._onRelease = function(e) {
        ...
        if (e.gesture.deltaY > this.viewHeight) {
          return this._dragged = false;
        } else {
          return this._hide();
        }
      };
      ...
      CategoryListNarrow.prototype._hide = function() {
        this.ui.pull.removeClass('');
        this._pullDownDistance = 0;
        this.setDistance(0);
        webkitCancelRequestAnimationFrame(this._anim);
        this._anim = null;
...
(function() {
  ...
  require.config({
    shim: {
      ...
      app: {
        deps: ['cordovaShim', 'marionette', 'backbone.stickit', 'backbone.localStorage', 'backbone.virtualcollection', 'backbone.hammer', 'jquery.ui.effect', 'jquery.ui.effect-bounce', 'hammerjs', 'rolejs']
      }
    },
    paths: {
  ...
  if (!this.Marionette) {
    require(['underscore', 'backbone', 'backbone.stickit', 'backbone.virtualcollection', 'backbone.localStorage', 'marionette', 'jquery.ui.effect', 'jquery.ui.effect-bounce', 'hammerjs', 'rolejs'], function(Underscore, Backbone, Stickit, VirtualCollection, LocalStorage, Marionette) {
