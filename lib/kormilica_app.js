...
// AMD
if(typeof define == 'function' && define.amd) {
  define('jquery-hammerjs',['hammerjs', 'jquery'], setupPlugin);
}
...
(function (global, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('backbone.virtualcollection',['underscore', 'backbone'], factory);
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    // AMD
    define('backbone.hammer',['underscore', 'backbone', 'hammerjs'], function(_, Backbone) {
...
(function() {
  ...
  define('views/modal_windows/check_contacts',['templates/modal_windows/check_contacts', 'helpers/application_helpers'], function(template, Helpers) {
    ...
    return CheckContactsView = (function(_super) {
      ...
      CheckContactsView.prototype.addressLength = 10;
      ...
      CheckContactsView.prototype.deactivateDeliveryButton = function() {
        var button;
        button = this.$el.find('.kormapp-delivery');
      ...
      CheckContactsView.prototype.activateDeliveryButton = function() {
        var button;
        button = this.$el.find('.kormapp-delivery-inactive');
...
(function() {
  ...
  define('views/header/header',['views/header/top_check', 'templates/header/header', 'helpers/application_helpers'], function(TopCheckView, template, Helpers) {
    ...
    return HeaderView = (function(_super) {
      ...
      HeaderView.prototype.className = 'kormapp-header';
  ...
  define('views/modal_windows/vendor_page',['templates/modal_windows/vendor_page', 'helpers/application_helpers'], function(template, Helpers) {
    ...
    return VendorPageView = (function(_super) {
      ...
      VendorPageView.prototype._setScrollableAreaHeight = function() {
        var scrollableHeight, vendorDescription;
        vendorDescription = $('.kormapp-vendor-description');
        scrollableHeight = $(window).height() / 2;
        return vendorDescription.css('max-height', scrollableHeight);
      };
...
(function() {
  ...
  define('controllers/make_order',['models/order', 'settings'], function(Order, Settings) {
    ...
    return MakeOrderController = (function(_super) {
      ...
      MakeOrderController.prototype.perform = function(_arg) {
        var cart, order,
          _this = this;
        cart = _arg.cart;
  ...
  define('templates/wide_layout',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div role='kormapp-header-region'></div>\n<div class='kormapp-content' role='kormapp-center-region'>\n  <div class='kormapp-sidebar-container' role='kormapp-sidebar-region'>\n    <div role='kormapp-sidebar-categories-region'></div>\n    <div role='kormapp-sidebar-check-region'></div>\n  </div>\n  <div class='kormapp-products-container' role='kormapp-products-region'></div>\n</div>\n<div class='kormapp-footer' role='kormapp-footer-region'></div>\n<div role='kormapp-modal-region'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
  ...
  define('templates/narrow_layout',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div role='kormapp-categories-region'></div>\n<div role='kormapp-header-region'></div>\n<div class='kormapp-content' role='kormapp-center-region'>\n  <div role='kormapp-products-region'></div>\n</div>\n<div class='kormapp-footer' role='kormapp-footer-region'></div>\n<div role='kormapp-check-region'></div>\n<div role='kormapp-modal-region'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
  ...
  define('templates/categories/category',[],function() {
    return function(context) {
      ...
      render = function() {
        ...
        $o = [];
        $o.push("<a class='category-item'>" + ($e($c(this.name))) + "</a>");
        return $o.join("\n").replace(/\s([\w-]+)='true'/mg, ' $1').replace(/\s([\w-]+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
(function() {
  define('templates/categories/category_list_narrow',[],function() {
    return function(context) {
      var render;
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='kormapp-list-container' role='kormapp-list-container'></div>\n<div class='kormapp-pull-tag' role='kormapp-pull-tag'></div>\n<div class='kormapp-categories-modal'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
(function() {
  ...
  define('views/categories/category_list_narrow',['templates/categories/category_list_narrow', 'views/categories/category'], function(template, CategoryView) {
    ...
    return CategoryListNarrow = (function(_super) {
      ...
      function CategoryListNarrow() {
        this.modalHide = __bind(this.modalHide, this);
        this.modalShow = __bind(this.modalShow, this);
        this.updateDistance = __bind(this.updateDistance, this);
        this.setDistance = __bind(this.setDistance, this);
        this._hide = __bind(this._hide, this);
        this._showList = __bind(this._showList, this);
        this._onDragDown = __bind(this._onDragDown, this);
        this._onRelease = __bind(this._onRelease, this);
        this._onTouch = __bind(this._onTouch, this);
        _ref = CategoryListNarrow.__super__.constructor.apply(this, arguments);
        return _ref;
      }

      CategoryListNarrow.prototype.template = template;

      CategoryListNarrow.prototype.className = 'kormapp-categories-list-narrow';

      CategoryListNarrow.prototype.itemView = CategoryView;

      CategoryListNarrow.prototype.itemViewContainer = '@kormapp-list-container';

      CategoryListNarrow.prototype.initialize = function() {
        this.on('itemview:category:click', this._hide);
        this._dragged = false;
        this._anim = null;
        this._pullDownDistance = 0;
        this.viewHeight = 300;
        return this.workDistance = 63;
      };

      CategoryListNarrow.prototype.ui = {
        pull: '@kormapp-pull-tag',
        modal: '.kormapp-categories-modal'
      };

      CategoryListNarrow.prototype.events = {
      ...
      CategoryListNarrow.prototype.onRender = function() {
        return this.$el.hammer();
      };

      CategoryListNarrow.prototype._onTouch = function(e) {
        return this._hide();
      };

      CategoryListNarrow.prototype._onRelease = function(e) {
        if (!this._dragged) {
          return;
        }
        webkitCancelRequestAnimationFrame(this._anim);
        if (this._pullDownDistance >= this.workDistance) {
          this._dragged = false;
          return this._showList();
        } else {
          this.$el.addClass('kormapp-slide-up');
          return this._hide();
        }
      };

      CategoryListNarrow.prototype._onDragDown = function(e) {
        this._dragged = true;
        if (!this._anim) {
          this.updateDistance();
        }
        e.gesture.preventDefault();
        return this._pullDownDistance = _.min([e.gesture.deltaY, this.viewHeight]);
      };

      CategoryListNarrow.prototype._showList = function() {
        this._down = true;
        this.$el.addClass('kormapp-slided-down');
        this.setDistance(this.viewHeight);
        return setTimeout(this.modalShow, 500);
      };

      CategoryListNarrow.prototype._hide = function(e) {
        var _this = this;
        if (e instanceof jQuery.Event) {
          e.preventDefault();
        }
        this.$el.removeClass('kormapp-slided-down');
        if (this._down) {
          this.$el.addClass('kormapp-slide-up');
        }
        this._pullDownDistance = 0;
        ...
        this._down = false;
        return setTimeout((function() {
          _this.$el.removeClass('kormapp-slide-up');
          return _this.modalHide();
        }), 500);
      };

      CategoryListNarrow.prototype.setDistance = function(dist) {
        this.el.style.transform = "translate3d(0, " + dist + "px, 0)";
        return this.el.style.webkitTransform = "translate3d(0, " + dist + "px, 0) scale3d(1,1,1)";
      };

      CategoryListNarrow.prototype.updateDistance = function() {
        this.setDistance(this._pullDownDistance);
        return this._anim = webkitRequestAnimationFrame(this.updateDistance);
      };

      CategoryListNarrow.prototype.modalShow = function() {
        this.el.style.height = '200%';
        return this.ui.modal.show();
      };

      CategoryListNarrow.prototype.modalHide = function() {
        this.el.style.height = '';
        return this.ui.modal.hide();
      };
  ...
  define('controllers/current_category',[],function() {
    ...
    return CurrentCategoryController = (function(_super) {
      ...
      CurrentCategoryController.prototype.initialize = function(_arg) {
        var _this = this;
        this.profile = _arg.profile, this.sorted = _arg.sorted, this.view = _arg.view;
        return this.listenTo(this.view, 'itemview:category:click', function(view, _arg1) {
          var model;
          model = _arg1.model;
          return _this.set(model.id);
        });
      };

      CurrentCategoryController.prototype.set = function(id) {
        this.profile.set('current_category_id', id);
...
(function() {
  define('app',['controllers/cart', 'controllers/check', 'views/header/header', 'views/products/products', 'views/modal_windows/vendor_page', 'controllers/footer', 'controllers/order', 'controllers/update_manager', 'controllers/checkout', 'controllers/modal', 'views/wide_layout', 'views/narrow_layout', 'views/categories/category_list', 'views/categories/category_list_narrow', 'views/check/check', 'controllers/data_repository', 'controllers/reflection', 'controllers/current_category'], function(CartController, CheckController, HeaderView, ProductsView, VendorPageView, FooterController, OrderController, UpdateManager, CheckoutController, ModalController, WideLayout, NarrowLayout, CategoryList, CategoryListNarrow, CheckView, DataPreloader, Reflection, CurrentCategoryController) {
    var App;
    App = new Marionette.Application;
    App.version = '0.1.31';
    App.addInitializer(function(_arg) {
      var bundle, categoryList, headerView, sorted_products;
      bundle = _arg.bundle;
      App.bundle = bundle;
      ...
      categoryList = App.isWide ? new CategoryList({
  ...
  define('data/bundle',[],function() {
    return {
      "vendor": {
        ...
        "city": "Чебоксары",
        "updated_at": "2014-04-02T20:13:42.730+04:00",
        "mobile_description": "Только у нас <b>американские пончики donuts</b>, как в \"Симпсонах\"! \r\n\r\nКоробка с 6 пончиками стоит дешевле, чем 6 пончиков по отдельности! Не упустите свой шанс наесть бока и щёки!\r\n\r\nДоставка по Чебоксарам от 1 коробки - всего 100 рублей!\r\n\r\nПри заказе от 3 коробок (18 пончиков) - доставка бесплатная!",
        "mobile_subject": "Супер-пончики donuts",
        "mobile_title": "Доставка<br>пончиков",
        "mobile_footer": "Выберите блюдо на заказ",
        "mobile_delivery": "Доставка бесплатно от 500 руб.",
        "mobile_logo_url": "data/images/mobile_logo.png",
        "minimal_price": {
          "cents": 50000,
          "currency": "RUB"
        },
      ...
      "products": [
        {
          ...
          "category_id": 1,
          "title": "Вкусняшка 2",
          "updated_at": "2014-03-31T10:47:08.594+04:00",
          "position": 7,
          "price": {
            "cents": 99900,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/9/mobile_9.png"
          }
        }, {
          "id": 13,
          "category_id": 1,
          "title": "Вкусняшка 6",
          "updated_at": "2014-03-28T12:49:29.836+04:00",
          "position": 2,
          "price": {
            "cents": 3300,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/13/mobile_13.png"
          }
        }, {
          "id": 14,
          "category_id": 1,
          "title": "Вкусняшка 7",
          "updated_at": "2014-03-28T12:47:58.483+04:00",
          "position": 1,
          "price": {
            "cents": 2900,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/14/mobile_14.png"
          }
        }, {
          "id": 10,
          "category_id": 1,
          "title": "Вкусняшка 3",
          "updated_at": "2014-03-28T12:48:59.814+04:00",
          "position": 6,
          "price": {
            "cents": 32300,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/10/mobile_10.png"
          }
        }, {
          "id": 12,
          "category_id": 1,
          "title": "Вкусняшка 5",
          "updated_at": "2014-03-28T12:48:23.825+04:00",
          "position": 3,
          "price": {
            "cents": 66600,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/12/mobile_12.png"
          }
        }, {
          "id": 11,
          "category_id": 1,
          "title": "Вкусняшка 4",
          "updated_at": "2014-03-28T12:50:17.351+04:00",
          "position": 4,
          "price": {
            "cents": 148800,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/11/mobile_11.png"
          }
        }
      ],
      "update": "now"
...
(function() {
  ...
  require.config({
    shim: {
      ...
      app: {
        deps: ['cordovaShim', 'marionette', 'backbone.stickit', 'backbone.localStorage', 'backbone.virtualcollection', 'backbone.hammer', 'jquery.ui.effect', 'jquery.ui.effect-bounce', 'hammerjs', 'jquery-hammerjs', 'rolejs']
      }
    },
    paths: {
  ...
  if (!this.Marionette) {
    require(['underscore', 'backbone', 'hammerjs', 'jquery-hammerjs', 'backbone.stickit', 'backbone.virtualcollection', 'backbone.localStorage', 'backbone.hammer', 'marionette', 'jquery.ui.effect', 'jquery.ui.effect-bounce', 'rolejs'], function(Underscore, Backbone, Hammer, JqueryHammer, Stickit, VirtualCollection, LocalStorage, BackboneHammer, Marionette) {
