...
(function() {
  ...
  require(['marionette', 'backbone.stickit', 'backbone.localStorage', 'jquery.ui.effect', 'jquery.ui.effect-bounce'], function() {
    return require(['app', 'data/vendor_predefined'], function(KormApp, vendor) {
      window.App = KormApp;
