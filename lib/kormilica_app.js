...
define("backbone.virtualcollection", ["underscore","backbone"], function(){});
...
(function() {
  ...
  if (!this.Marionette) {
    require(['backbone', 'backbone.stickit', 'backbone.virtualcollection', 'backbone.localStorage', 'marionette', 'jquery.ui.effect', 'jquery.ui.effect-bounce'], function(Backbone, Stickit, VirtualCollection, LocalStorage, Marionette) {
