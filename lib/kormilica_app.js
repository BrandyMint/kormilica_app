    ...
    return WideLayout = (function(_super) {
      ...
      WideLayout.prototype.onRender = function() {
        return this.modalRegion.on('close', function(e) {
          return Helpers.body_scroll_top();
        });
      };
  ...
  define('views/categories/category_list',['views/categories/category'], function(CategoryView) {
    ...
    return CategoryList = (function(_super) {
      ...
      function CategoryList() {
        this.updateProducts = __bind(this.updateProducts, this);
      ...
      CategoryList.prototype.initialize = function() {
        return this.on('itemview:category:click', this.updateProducts);
      };

      CategoryList.prototype.updateProducts = function(view, data) {
        if (data.model) {
          return this.options.products.updateFilter({
...
(function() {
  define('app',['controllers/cart', 'controllers/check', 'views/header/header', 'views/products/products', 'views/modal_windows/vendor_page', 'controllers/footer', 'controllers/order', 'controllers/update_manager', 'controllers/checkout', 'controllers/modal', 'views/wide_layout', 'views/narrow_layout', 'views/categories/category_list', 'controllers/data_repository', 'controllers/reflection'], function(CartController, CheckController, HeaderView, ProductsView, VendorPageView, FooterController, OrderController, UpdateManager, CheckoutController, ModalController, WideLayout, NarrowLayout, CategoryList, DataPreloader, Reflection) {
    var App;
    App = new Marionette.Application;
    App.version = '0.1.30';
    App.addInitializer(function(_arg) {
      var bundle, headerView, sorted_products, type, _ref;
      bundle = _arg.bundle, type = _arg.type;
      App.bundle = bundle;
      ...
      */
      ...
      App.mainLayout = type === 'wide' ? new WideLayout() : new NarrowLayout();
      ...
      sorted_products = new Backbone.VirtualCollection(App.products, {
        comparator: 'position',
        filter: {
          category_id: (_ref = App.categories.first()) != null ? _ref.id : void 0
        }
      });
      if (type === 'wide') {
...
(function() {
  ...
  require(['app', 'data/bundle'], function(KormApp, bundle) {
    ...
    layoutType = type === 'web_desktop' ? 'wide' : 'narrow';
