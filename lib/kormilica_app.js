  ...
  define('notification',[],function() {
    ...
    Notification = {
      alert: function(message, completeCallback, title, buttonLabel) {
        ...
        return completeCallback != null ? completeCallback.call(this) : void 0;
      },
      confirm: function(message, resultCallback, title, buttonLabels) {
        var res;
        res = window.confirm(message);
        if (resultCallback != null) {
          resultCallback.call(this, res);
        }
        return res;
      }
    };
  ...
  define('views/check/check',['templates/check/check', 'views/check/check_cart_item', 'helpers/application_helpers'], function(template, CheckCartItemView, Helpers) {
    ...
    return Check = (function(_super) {
      ...
      Check.prototype.showErrors = function(e) {
        e.preventDefault();
        return window.navigator.notification.alert('Впишите телефон и адрес доставки');
      };
  ...
  define('controllers/check',['views/check/check'], function(CheckView) {
    ...
    return CheckController = (function(_super) {
      ...
      CheckController.prototype.initialize = function(_arg) {
        var _this = this;
        this.app = _arg.app, this.user = _arg.user, this.cart = _arg.cart, this.vendor = _arg.vendor;
        this.app.commands.setHandler('check:show', function() {
      ...
      ProductsUpdaterController.prototype.perform = function(interactive) {
        ...
        return $.ajax({
          ...
          success: function(data) {
            var _ref1;
            if (interactive) {
              window.navigator.notification.alert("Обновлено продуктов: " + (data != null ? (_ref1 = data.products) != null ? _ref1.length : void 0 : void 0));
            }
            return _this._update(data);
          },
          error: function(e) {
            if (interactive) {
              return window.navigator.notification.alert("Ошибка обновления списка продуктов");
            } else {
...
(function() {
  ...
  define('controllers/minimal_price_checker',['helpers/application_helpers'], function(Helpers) {
    var MinimalPriceChecker, _ref;
    return MinimalPriceChecker = (function(_super) {
      __extends(MinimalPriceChecker, _super);

      function MinimalPriceChecker() {
        _ref = MinimalPriceChecker.__super__.constructor.apply(this, arguments);
        return _ref;
      }

      MinimalPriceChecker.prototype.initialize = function(_arg) {
        var _this = this;
        this.app = _arg.app, this.cart = _arg.cart, this.vendor = _arg.vendor, this.vent = _arg.vent;
        this.minimalPrice = this.vendor.get('minimal_price');
        return this.vent.on('checkout:clicked top_check:clicked', function() {
          if (_this._isGreaterThanMinimalPrice()) {
            return _this.app.execute('check:show');
          } else {
            return alert("Минимальный заказ от " + (Helpers.money_txt(_this.minimalPrice)));
          }
        });
      };

      MinimalPriceChecker.prototype._isGreaterThanMinimalPrice = function() {
        var currentTotalCost;
        currentTotalCost = this.cart.get('total_cost_cents');
        return currentTotalCost > this.minimalPrice.cents;
      };

      return MinimalPriceChecker;
    ...
    return ReflectionController = (function() {
      function ReflectionController() {
        $(document).on("touchstart mousedown", '.kormapp-reflection', function(e) {
          ...
          window.__reflection_callback = function() {
            el.removeClass('kormapp-reflection-on');
            window.clearTimeout(window.__reflection_timeout_id);
            return window.__reflection_callback = void 0;
          };
          if (window.__reflection_timeout_id != null) {
            window.clearTimeout(window.__reflection_timeout_id);
          }
          window.__reflection_timeout_id = window.setTimeout(window.__reflection_callback, 2000);
          return el.on("touchend mouseup mousemove", function() {
            var _ref;
            return (_ref = window.__reflection_callback) != null ? _ref.call() : void 0;
          });
        });
      }
...
(function() {
  define('app',['controllers/cart', 'controllers/check', 'views/header/header', 'views/products/products', 'views/modal_windows/vendor_page', 'controllers/footer', 'controllers/order', 'controllers/update_manager', 'controllers/minimal_price_checker', 'controllers/modal', 'views/main_layout', 'controllers/data_repository', 'controllers/reflection'], function(CartController, CheckController, HeaderView, ProductsView, VendorPageView, FooterController, OrderController, UpdateManager, MinimalPriceChecker, ModalController, MainLayout, DataPreloader, Reflection) {
    var App;
    App = new Marionette.Application;
    App.version = '0.1.18';
    App.addInitializer(function(bundle) {
      ...
      return new MinimalPriceChecker({
        app: App,
        cart: App.cart,
        vendor: App.vendor,
        vent: App.vent
    ...
    App.on('initialize:after', function() {
      new Reflection();
      return console.log("App inintialize:after", Date.now());
    });
    return App;
  });
  ...
  define('data/bundle',[],function() {
    return {
      "vendor": {
        ...
        "phone": "79033891228",
        "city": "Чебоксары",
        "updated_at": "2014-03-19T13:21:40.096+04:00",
        "mobile_description": "Только у нас, <b>жирные пончики</b>. В течении часа. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede <i>mollis pretium. Integer tincidunt. Cras</i> dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, <blink>sem quam semper libero</blink>, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc,\r\n",
      ...
      "categories": [
        {
          "id": 1,
          "name": "Пончики",
          "updated_at": "2014-03-03T10:33:08.327+04:00"
        }
      ],
      "products": [
        {
          ...
          "updated_at": "2014-03-19T18:16:42.654+04:00",
          "position": 5,
          "price": {
            "cents": 12000,
            "currency": "RUB"
          ...
          "updated_at": "2014-03-19T18:16:48.368+04:00",
          "position": 6,
          "price": {
            "cents": 173000,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/3/mobile_donut_3.png"
          }
        }, {
          "id": 2,
          "category_id": 1,
          "title": "Пончик со сливочной начинкой",
          "updated_at": "2014-03-19T18:22:26.067+04:00",
          "position": 7,
          "price": {
            "cents": 15000,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/2/mobile_kak_prigotovit_ponchiki_s_glazuryu.jpg"
          }
        }, {
          "id": 4,
          "category_id": 1,
          "title": "Пончик с начинкой двойной шоколад",
          "updated_at": "2014-03-19T18:25:49.065+04:00",
          "position": 3,
          "price": {
            "cents": 13000,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/4/mobile_kak_prigotovit_ponchiki_s_glazuryu.jpg"
          }
        }, {
          "id": 1,
          "category_id": 1,
          "title": "Пончик с начинкой ваниль",
          "updated_at": "2014-03-19T18:26:09.491+04:00",
          "position": 2,
          "price": {
            "cents": 16000,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/1/mobile_kak_prigotovit_ponchiki_s_glazuryu.jpg"
          }
        }, {
          "id": 6,
          "category_id": 1,
          "title": "Пончик с банановой начинкой",
          "updated_at": "2014-03-19T18:26:32.995+04:00",
          "position": 4,
          "price": {
            "cents": 5600,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/6/mobile_donut_1.png"
          }
        }, {
          "id": 7,
          "category_id": 1,
          "title": "Пончик с начинкой яблоко-корица.",
          "updated_at": "2014-03-19T18:26:40.422+04:00",
          "position": 1,
          "price": {
            "cents": 10000,
            "currency": "RUB"
          ...
          "image": {
            "mobile_url": "http://aydamarket.ru/uploads/product/image/7/mobile_donut_2.png"
          }
        }
      ]
    };
...
(function() {
  ...
  require.config({
    shim: {
      ...
      app: {
        deps: ['marionette', 'notification', 'backbone.stickit', 'backbone.localStorage', 'backbone.virtualcollection', 'jquery.ui.effect', 'jquery.ui.effect-bounce']
      }
    },
    paths: {
  ...
  if (!this.Marionette) {
    require(['underscore', 'backbone', 'backbone.stickit', 'backbone.virtualcollection', 'backbone.localStorage', 'marionette', 'jquery.ui.effect', 'jquery.ui.effect-bounce'], function(Underscore, Backbone, Stickit, VirtualCollection, LocalStorage, Marionette) {
      return _this.Marionette = Marionette;
    });
  }

  if (((_ref = window.navigator) != null ? _ref.notification : void 0) == null) {
    require(['notification'], function(Notification) {
      if (window.navigator == null) {
        window.navigator = {};
      }
      return window.navigator.notification = Notification;
    });
  }
