...
(function() {
  ...
  define('controllers/header',['views/header/header', 'views/header/header_check'], function(HeaderView, HeaderCheckView) {
    var HeaderController, _ref;
    return HeaderController = (function(_super) {
      __extends(HeaderController, _super);

      function HeaderController() {
        this.checkRegion = __bind(this.checkRegion, this);
      ...
      HeaderController.prototype.initialize = function(options) {
        ...
        this.layout = new HeaderView({
          app: this.app,
          cart: this.cart
        });
        this.layout.on('show', function() {
          return _this.checkRegion();
        });
        this.showHeader();
      ...
      HeaderController.prototype.showHeader = function() {
        ...
        return this.app.headerRegion.show(this.layout);
      };

      HeaderController.prototype.checkRegion = function() {
        var checkView;
        checkView = new HeaderCheckView({
          app: this.app,
          cart: this.cart
        });
        return this.layout.checkRegion.show(checkView);
      };
