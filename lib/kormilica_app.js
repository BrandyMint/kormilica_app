...
define("imgcache", ["jquery"], function(){});
...
(function() {
  ...
  define('views/products/product',['templates/products/product', 'views/products/cart_button', 'views/products/empty_cart_button', 'helpers/application_helpers'], function(productTemplate, CartButton, EmptyCartButton, Helpers) {
    ...
    return ProductView = (function(_super) {
      ...
      function ProductView() {
        this.getCachedImg = __bind(this.getCachedImg, this);
      ...
      ProductView.prototype.getCachedImg = function($img) {
        var cached, imgUrl, remote, _ref1;
        imgUrl = (_ref1 = this.model.get('image')) != null ? _ref1.mobile_url : void 0;
        if (!imgUrl) {
          return;
        }
        remote = function() {
        ...
        if (ImgCache && (window.cordova != null)) {
          cached = function() {
            return ImgCache.useCachedFileWithSource($img, imgUrl, null, (function() {
              return ImgCache.cacheFile(imgUrl);
            }));
          };
          if (ImgCache.ready) {
            return cached();
          } else {
            this.stopListening(this.app, 'img-cache:ready');
            return this.listenToOnce(this.app, 'img-cache:ready', cached);
          }
        } else {
          return remote();
        }
      ...
      ProductView.prototype.onRender = function() {
        ...
        this.showButton();
        return this.getCachedImg(this.ui.img);
      };
  ...
  define('app',['controllers/cart', 'controllers/check', 'views/header/header', 'views/products/products', 'views/modal_windows/vendor_page', 'controllers/footer', 'controllers/order', 'controllers/update_manager', 'controllers/checkout', 'controllers/modal', 'views/main_layout', 'controllers/data_repository', 'controllers/reflection'], function(CartController, CheckController, HeaderView, ProductsView, VendorPageView, FooterController, OrderController, UpdateManager, CheckoutController, ModalController, MainLayout, DataPreloader, Reflection) {
    ...
    App.on('start', function() {
      ...
      document.addEventListener('ImgCacheReady', (function() {
        return App.trigger('img-cache:ready');
      }), false);
...
(function() {
  ...
  require.config({
    shim: {
      ...
      app: {
        deps: ['cordovaShim', 'imgcache', 'marionette', 'backbone.stickit', 'backbone.localStorage', 'backbone.virtualcollection', 'jquery.ui.effect', 'jquery.ui.effect-bounce']
      }
    },
    paths: {
