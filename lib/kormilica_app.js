  ...
  define('templates/footer/footer',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='clearfix row' id='kormapp-workspace'>\n  <div class='column full kormapp-delivery-discount'>\n    <p>Выберите блюдо на заказ.</p>\n    <p class='kormapp-free-delivery'>Доставка бесплатно от 500 руб.</p>\n  </div>\n</div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
  ...
  define('templates/footer/_checkout',[],function() {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='column full kormapp-footer-content'>\n  <a class='kormapp-checkout' href='#777'>ОФОРМИТЬ ЗАКАЗ</a>\n</div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
