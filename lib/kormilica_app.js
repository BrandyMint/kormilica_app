...
(function() {
  define('app',['controllers/cart', 'controllers/check', 'views/header/header', 'views/products/products', 'views/modal_windows/vendor_page', 'controllers/footer', 'controllers/order', 'controllers/update_manager', 'controllers/minimal_price_checker', 'controllers/modal', 'views/main_layout', 'controllers/data_repository'], function(CartController, CheckController, HeaderView, ProductsView, VendorPageView, FooterController, OrderController, UpdateManager, MinimalPriceChecker, ModalController, MainLayout, DataPreloader) {
    var App;
