  ...
  define('controllers/reflection',[],function() {
    ...
    return ReflectionController = (function() {
      ...
      $(document).on("touchstart mousedown", '.kormapp-reflection', function(e) {
        return $(this).addClass('kormapp-mousedown');
      }).on("touchend mouseup", '.kormapp-reflection', function(e) {
        return $(this).removeClass('kormapp-mousedown');
      }).on("mousemove", '.kormapp-reflection', function(e) {
        return $(this).removeClass('kormapp-mousedown');
      });
