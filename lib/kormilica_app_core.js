...
(function() {
  define('data/vendor_predefined',[],function() {
    return {
      "key": "98b118b9fa89e7aa8c18b0b43f7c178e",
      ...
      "mobile_delivery": "Доставка бесплатно от 500 руб.",
      "mobile_logo": {
        "mobile_url": "http://3001.vkontraste.ru/uploads/vendor/mobile_logo/5/mobile_logo.png"
      },
      "minimal_price": {
        "cents": 0,
        "currency": "RUB"
...
(function() {
  define('app',['models/profile', 'models/vendor', 'controllers/cart', 'collections/cart_items', 'controllers/check', 'collections/products', 'views/header/header', 'views/products/products', 'controllers/footer', 'controllers/order', 'models/cart', 'controllers/modal', 'data/vendor_predefined'], function(Profile, Vendor, CartController, CartItems, CheckController, ProductsCollection, HeaderView, ProductsView, FooterController, OrderController, Cart, ModalController, VendorPredefined) {
    var App;
