...
(function() {
  define('templates/check/check_cart_item',['jquery', 'underscore'], function($, _) {
    return function(context) {
      var render;
      render = function() {
        var $c, $e, $o;
    ...
    return FooterController = (function(_super) {
      ...
      FooterController.prototype.initialize = function(options) {
        ...
        return this.footerView.on('delivery:clicked', function() {
          return _this.vent.trigger('delivery:clicked');
        });
      };
...
(function() {
  ...
  define('controllers/orders',['models/order'], function(Order) {
    var OrdersController, _ref;
    return OrdersController = (function(_super) {
      __extends(OrdersController, _super);

      function OrdersController() {
        this.createOrder = __bind(this.createOrder, this);
        _ref = OrdersController.__super__.constructor.apply(this, arguments);
        return _ref;
      }

      OrdersController.prototype.initialize = function(options) {
        var _this = this;
        this.cart = options.cart, this.profile = options.profile, this.vent = options.vent, this.app = options.app;
        return this.vent.on('delivery:clicked', function() {
          return _this.createOrder();
        });
      };

      OrdersController.prototype.createOrder = function() {
        var formData, order, orderOptions;
        formData = this.app.request('form:data');
        this.profile.save({
          name: formData.name,
        ...
        return order.save(null, {
          success: function(model, response) {
            return App.vent.trigger('order:created', response);
          }
        });
      };

      OrdersController.prototype._getFormattedCartItems = function() {
...
(function() {
  define('app',['form-serialize', 'models/profile', 'controllers/cart', 'collections/cart_items', 'controllers/check', 'collections/products', 'views/products/products', 'controllers/header', 'controllers/footer', 'controllers/orders', 'models/cart', 'controllers/modal'], function(Profile, CartController, CartItems, CheckController, ProductsCollection, ProductsView, HeaderController, FooterController, OrdersController, Cart, ModalController) {
    var App;
